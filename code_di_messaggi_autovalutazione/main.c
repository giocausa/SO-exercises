...
int main(){
        ...
        ds_queue_gen_filter = msgget(key_queue_gen_filter,IPC_CREAT|0644);/* TODO: generare il descrittore coda generatore-filtro */
        ds_queue_filter_checksum =msgget(key_queue_filter_checksum,IPC_CREAT|0644);/* TODO: generare il descrittore coda filtro-checksum */
        ds_queue_checksum_visual =msgget(key_queue_checksum_visual,IPC_CREAT|0644); /* TODO: generare il descrittore coda checksum-visualizzatore */
